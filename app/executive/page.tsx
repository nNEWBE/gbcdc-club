...
const executiveMembers = [
  {
    ...
    achievements: ["Founded mentorship program", "Secured 5 industry partnerships", "Organized 30+ events"],
  ...
  },
  {
    ...
    achievements: ["Increased member engagement by 40%", "Led digital transformation", "Mentored 20+ juniors"],
  ...
  },
  {
    ...
    achievements: ["Streamlined communication systems", "Managed 500+ member database", "Organized annual report"],
  ...
  },
  {
    ...
    achievements: ["30% budget optimization", "Introduced digital payments", "Secured sponsorships worth ৳500K+"],
  ...
  },
  {
    ...
    achievements: ["Organized Career Fair 2025", "50+ successful events", "Built event management framework"],
  ...
  },
  {
    ...
    achievements: ["5K+ social media followers", "Created brand guidelines", "Led 3 viral campaigns"],
  ...
  },
  {
    ...
    achievements: ["Launched 6 training tracks", "Trained 300+ students", "Industry curriculum alignment"],
  ...
  },
  {
    ...
    achievements: ["Secured 10+ media features", "Built alumni network", "Organized press conferences"],
...
const tierConfig = {
  president: { gradient: "from-primary to-emerald-400", ring: "border-primary/30", badge: "President" },
  vp: { gradient: "from-neutral-800 to-neutral-600", ring: "border-neutral-400/30", badge: "Vice President" },
  executive: { gradient: "from-neutral-700 to-neutral-500", ring: "border-neutral-300/30", badge: null },
  director: { gradient: "from-neutral-600 to-neutral-400", ring: "border-neutral-300/20", badge: null },
};
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  {/* Avatar */}
                  <div className={`relative w-28 h-28 rounded-full bg-gradient-to-br ${config.gradient} flex items-center justify-center text-white text-3xl font-bold mb-5 group-hover:scale-105 transition-transform duration-500 shadow-xl shadow-black/10`}>
                    {member.initials}
                    <div className={`absolute inset-0 rounded-full border-2 ${config.ring} scale-[1.15]`} />
                  ...
                  <div className="mt-5 w-full">
                    <p className="text-xs font-semibold text-neutral-400 uppercase tracking-wider mb-3">Key Achievements</p>
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    <a href={member.social.linkedin} className="w-10 h-10 rounded-full bg-neutral-100 hover:bg-primary hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer" aria-label={`${member.name}'s LinkedIn`}>
                      <Linkedin size={16} />
                    </a>
                    <a href={member.social.facebook} className="w-10 h-10 rounded-full bg-neutral-100 hover:bg-primary hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer" aria-label={`${member.name}'s Facebook`}>
                      <Facebook size={16} />
                    </a>
                    <a href={`mailto:${member.social.email}`} className="w-10 h-10 rounded-full bg-neutral-100 hover:bg-primary hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer" aria-label={`Email ${member.name}`}>
                      <Mail size={16} />
                    </a>
                  </div>
                </div>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className={`relative w-20 h-20 rounded-full bg-gradient-to-br ${config.gradient} flex items-center justify-center text-white text-xl font-bold mb-4 group-hover:scale-110 transition-transform duration-500 shadow-lg shadow-black/10`}>
                    {member.initials}
                    <div className={`absolute inset-0 rounded-full border-2 ${config.ring} scale-110`} />
                  </div>
                  ...
                  <div className="mt-4 flex flex-wrap justify-center gap-2">
                    {member.achievements.slice(0, 2).map((a) => (
                      <span key={a} className="px-2.5 py-1 bg-neutral-50 rounded-full text-xs text-neutral-500 font-medium">
                        {a}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="mt-5 flex items-center gap-2">
                    <a href={member.social.linkedin} className="w-9 h-9 rounded-full bg-neutral-100 hover:bg-primary hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer" aria-label={`${member.name}'s LinkedIn`}>
                      <Linkedin size={14} />
                    </a>
                    <a href={member.social.facebook} className="w-9 h-9 rounded-full bg-neutral-100 hover:bg-primary hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer" aria-label={`${member.name}'s Facebook`}>
                      <Facebook size={14} />
                    </a>
                    <a href={`mailto:${member.social.email}`} className="w-9 h-9 rounded-full bg-neutral-100 hover:bg-primary hover:text-white flex items-center justify-center transition-all duration-300 cursor-pointer" aria-label={`Email ${member.name}`}>
                      <Mail size={14} />
                    </a>
                  </div>
                </div>
