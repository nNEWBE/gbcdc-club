...
const courses = [
  {
    ...
    modules: ["Social Media Strategy", "SEO Optimization", "Content Marketing", "Google Analytics", "Paid Advertising"],
    color: "bg-blue-500",
  },
  {
    icon: Code,
    ...
    modules: ["HTML & CSS Mastery", "JavaScript ES6+", "React & Next.js", "Backend with Node.js", "Database & Deployment"],
    color: "bg-primary",
  },
  {
    icon: TrendingUp,
    ...
    modules: ["Personal Finance 101", "Stock Market Basics", "Investment Strategies", "Risk Management", "Financial Planning"],
  ...
  },
  {
    ...
    modules: ["Design Thinking Process", "User Research", "Wireframing & Prototyping", "Figma Mastery", "Usability Testing"],
    color: "bg-purple-500",
  },
  {
    icon: Briefcase,
    ...
    modules: ["Business Writing", "Presentation Skills", "Public Speaking", "Negotiation Tactics", "Email Etiquette"],
    color: "bg-amber-500",
  },
  {
    icon: BarChart3,
    ...
    modules: ["Python Fundamentals", "Pandas & NumPy", "Data Visualization", "Statistical Analysis", "Machine Learning Intro"],
    color: "bg-rose-500",
  },
];
            ...
            >
              ...
              <div className={`${course.color} p-6 text-white relative overflow-hidden`}>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-lg font-bold mt-3 leading-snug">{course.title}</h3>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  <div className="text-center p-2 bg-neutral-50 rounded-lg">
                    <Clock size={14} className="text-neutral-400 mx-auto mb-1" />
                    <span className="text-xs font-medium text-neutral-600">{course.duration}</span>
                  </div>
                  <div className="text-center p-2 bg-neutral-50 rounded-lg">
                    <Users size={14} className="text-neutral-400 mx-auto mb-1" />
                    <span className="text-xs font-medium text-neutral-600">{course.students} students</span>
                  </div>
                  <div className="text-center p-2 bg-neutral-50 rounded-lg">
                    <Award size={14} className="text-neutral-400 mx-auto mb-1" />
                ...
                <div className="text-xs text-neutral-400 mb-4">
                  Instructor: <span className="font-semibold text-neutral-600">{course.instructor}</span>
                </div>

                {/* Expandable Modules */}
                <button
                  onClick={() =>
                    setExpandedCourse(expandedCourse === course.title ? null : course.title)
                  }
                ...
                {expandedCourse === course.title && (
                  ...
                  >
                    {course.modules.map((mod) => (
                      <li key={mod} className="flex items-center gap-2 text-sm text-neutral-600">
