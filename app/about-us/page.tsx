      ...
      <section className="py-20 md:py-28 bg-primary/5">
        <div className="section-container text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-white text-sm font-semibold rounded-full hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/20 transition-all duration-200 active:scale-95 cursor-pointer"
            >
              Join GBCDC
              <ArrowRight size={16} />
            </Link>
